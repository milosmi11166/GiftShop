...
values (1, "Odeća"), (2, "Mobilni telefoni"),(3, "Automobili"), (4, "Računari"), (5, "Nameštaj"), (6, "Igračke");
...
values (1, "Samsung Galaxy s7", "Poklanjam Samsung Galaxy s7", "img/samsungs7.jpg", null, null, true, 2, 1),
(2, "Jakna Zara", "Poklanjam Jakna Zara", "img/zarajacket.jpg", null, null, true, 1, 1);